...
from .instrument import BaseInstrument, SpecProtocol
...
class InstrumentFactory:
    ...
    def create(
        ...
        # specs is guaranteed to be a BaseSpec subclass at runtime via the decorator
        instr = klass(specs, loader, self.ctx)  # type: ignore[arg-type]
